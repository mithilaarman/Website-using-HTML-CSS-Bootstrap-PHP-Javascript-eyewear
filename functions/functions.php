<?php 
$db = mysqli_connect("localhost","root","","17.02.04.100");
// begin getRealIpUser functions
// for get the ip address
...
// input product request to database
// if anyone didn't login he can also add products in cart through ip address
function add_cart(){    
    global $db;    
...
//count from cart table db
//send it to heder file
//header file will show in top total price and total product
